...
var goTop = function () {
    ...
    top.mouseover(function (e) {
        $(this).css("background", "url(https://oj8yna8y7.qnssl.com/static/img/backtop.png) no-repeat 0px 0px");
        $(this).css('cursor', 'pointer');
        $(this).css('opacity', '1');
    });

    top.mouseout(function (e) {
        $(this).css("background", "url(https://oj8yna8y7.qnssl.com/static/img/backtop.png) no-repeat -70px 0px");
