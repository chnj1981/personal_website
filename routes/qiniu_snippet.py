...
#构建鉴权对象
q = Auth(QINIU_CONF['access_key'], QINIU_CONF['secret_key'])

#要上传的空间
bucket_name = QINIU_CONF['upload_bucket']
...
def upload(file):
    ...
    #上传到七牛后保存的文件名
    filename = QINIU_CONF['test_upload_folder'] + localfile
...
from qiniu.compat import urlparse, json, b
